<template>
  <div class="father">
    <router-link to="/backPlatform"><el-button style="background-color: rgba(239,148,228,0.5); border: none;color: #FFFFFF;font-size: larger; margin-left: 20px;margin-top: 20px; height: 45px;width: 45px" circle>
      ...
      <div class="son-right">
        <el-row type="flex" justify="center" align="middle">
          <el-form  ref="loginForm" :model="manager" :rules="rules" status-icon label-width="80px">
            ...
            <Myh style="font-size: 13px">Now Manager </Myh>
            <router-link to="/managerRegister" style="color:rgb(143,121,198);text-decoration: none;font-size: small;margin-right: 120px;">Sign Up</router-link>
