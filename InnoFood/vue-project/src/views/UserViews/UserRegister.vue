<template>
  <div class="father">
    <router-link to="/userLogin"><el-button style="background-color: rgba(239,148,228,0.5); border: none;color: #FFFFFF;font-size: larger; margin-left: 20px;margin-top: 20px; height: 45px;width: 45px" circle>
      ...
      <div class="son-right">
        <el-row type="flex" justify="center" align="middle">
          <el-form  ref="loginForm" :model="user" :rules="rules" status-icon label-width="80px">
            ...
            <span style="color: #a8a8ab;font-size: small">address</span>
            ...
            <el-form-item  prop="cpwd">
              <el-input v-model="user.cpwd" show-password></el-input>
            </el-form-item>
            ...
            <router-link to="/userLogin" style="color:rgb(143,121,198);text-decoration: none;font-size:small">Have Account?</router-link>
            <el-form-item>
