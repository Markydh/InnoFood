<template>
  <div class="father">
    <router-link to="/deliveryLogin"><el-button style="background-color: rgba(239,148,228,0.5); border: none;color: #FFFFFF;font-size: larger; margin-left: 20px;margin-top: 20px; height: 45px;width: 45px" circle>
    ...
    <div class="son">
      ...
      <div class="son-right">
        <el-row type="flex" justify="center" align="middle">
          <el-form  ref="loginForm" :model="delivery" :rules="rules" status-icon label-width="80px">
            ...
            <el-form-item prop="email">
              <el-input v-model="delivery.email" ></el-input>
            </el-form-item>
            ...
            <el-form-item id="password" prop="password">
              <el-input v-model="delivery.password" show-password></el-input>
            </el-form-item>
            <span style="color: #a8a8ab;font-size: small">confirm password</span>
            <el-form-item  prop="cpwd">
              <el-input v-model="delivery.cpwd" show-password></el-input>
            </el-form-item>
            <Myh style="font-size: 13px">Now Delivery </Myh>
            ...
            <router-link to="/deliveryLogin" style="color:rgb(143,121,198);text-decoration: none;font-size:small">Have Account?</router-link>
            <el-form-item>
      ...
      rules: {
        ...
        cpwd: [{
          ...
          validator: (rule, value, callback) => {
            ...
            } else if (value !== this.delivery.password) {
  ...
  methods: {
    register(){
      this.$refs.loginForm.validate((valid) => {
        if (valid) {
          this.request.get("/delivery/register",{
            params:{
            ...
            if(response == 0){
              ...
              this.request.post("/delivery", this.delivery).then(res => {
                console.log(res)
                ...
                if (!res) {
                  ...
                  this.$router.push({ path: "/deliveryLogin" });
                }
              });
            }
          })
